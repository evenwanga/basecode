...
public class IntegrationTest {
        ...
        void createTenantAndRegisterUser() {
                ...
                var user = identityService.registerUser(tenant.getId(), "张三", "test@example.com", null, "Passw0rd!");
                assertThat(user.getId()).isNotNull();

                identityService.addMembership(user.getId(), tenant.getId(), null, "admin");
                assertThat(identityService.findByEmail(tenant.getId(), "test@example.com")).isPresent(); // Also update
                                                                                                         // findByEmail
        ...
        void otpFlowWithFixedCode() {
                ...
                var user = identityService.registerUser(tenant.getId(), "李四", "otp@example.com", null, "Passw0rd!");
